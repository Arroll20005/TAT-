#!/bin/bash
# Extract frames from video as WebP images
# Run this script after placing animation.mp4 in public/images/video/
...
# Extract frames as WebP with zero-padded numbering
